...
namespace r2d2::distance {
    ...
    /// \detail
    /// This class uses a lidar to measure the distance between the lidar and the closest object.
    /// When a distance request has been received this class sends the smallest detected distance over the can-bus.
    class module_c : public base_module_c {
        ...
        public:
            ...
            /// \detail Constructs a r2d2::distance::module_c object that will use the given comm and lidar.
            ...
            /// \brief This modules process function that allows the module to process (input)data.
            /// \detail
            /// In this function the module first checks for distance request frames. If a distance request frame has been received,
            /// the module will update its distance data with input from the lidar. It then searches for the smallest distance
            /// and sends this distance over the can-bus in a frame_distance_s packet.
